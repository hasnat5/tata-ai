        ...
        case "updateScenes": {
          ...
          for (const update of updates) {
            ...
            if (update.includeBrandLogo !== undefined)
              sceneUpdates.includeBrandLogo = update.includeBrandLogo;
            if (
              ...
              sceneUpdates.script = {
                characterId:
                  ...
                  "",
                dialogue:
                  update.dialogue ?? existingScene?.script?.dialogue ?? "",
              };
            }
    ...
    async (
      ...
      if (
        ...
        outputPreprocessing = {
          ...
          scenesTagged: (result.data.sceneUpdates as unknown[]).length,
        };
      }
      ...
      if (result.data?.generatedLocations || result.data?.generatedAttires) {
      ...
      let outputGeneratedThumbnails: GeneratedThumbnailsResult | undefined;
      if (result.data?.generatedThumbnails) {
        outputGeneratedThumbnails = {
          ...
          aspectRatio: result.data.aspectRatio as "16:9" | "9:16" | undefined,
        };
      }
  ...
  const getProjectState = useCallback(() => {
    ...
    return {
      ...
      characterAttires: currentProject.characterAttires.map((att) => ({
        ...
        characterName:
          currentProject.characters.find((c) => c.id === att.characterId)
            ?.name || "Unknown",
        name: att.name,
          ...
          for (const toolCall of data.toolCalls) {
            ...
            if (toolCall.toolName === "request_upload") {
              setUploadRequest({
                ...
                targetId: toolCall.args.targetId as string | undefined,
              });
            ...
            try {
              const {
                ...
                outputFinalVideo,
                outputMessage,
              } = await executeToolCall(toolCall, (status, msg) => {
              ...
              if (outputGeneratedThumbnails) {
                const thumbnailsStep: AgentStep = {
                  ...
                  generatedThumbnails: outputGeneratedThumbnails,
                  timestamp: Date.now(),
                };
      ...
      <div className="flex-1 overflow-y-auto">
        {messages.length === 0 ? (
          <div className="flex h-full flex-col items-center justify-center p-8 text-center">
            ...
            <h2 className="mb-2 text-xl font-semibold">Welcome to TataAI</h2>
            <p className="max-w-md text-muted-foreground">
              Your AI-powered video director for creating professional,
              compliant video content. I&apos;ll guide you through defining your
              project, characters, and script—then help generate visual assets
              for production.
            </p>
