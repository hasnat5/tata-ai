    ...
    async start(controller) {
      ...
      try {
        ...
        sendEvent(controller, {
          ...
          description:
            "Initiating deep research analysis on uploaded documents",
        });
        ...
        sendEvent(controller, {
          ...
          message:
            "AI agent is analyzing your documents. This involves multiple analysis passes...",
          phase: "researching",
        });
        ...
        try {
          ...
          const researchStream = await ai.models.generateContentStream({
            ...
            contents: [
              {
                parts: [{ text: researchPrompt }, ...pdfContents],
              },
            ],
            config: {
              thinkingConfig: {
            ...
            if (chunk.candidates?.[0]?.content?.parts) {
              for (const part of chunk.candidates[0].content.parts) {
                ...
                if ("thought" in part && part.thought) {
                  ...
                  if (
                    thoughtText.toLowerCase().includes("search") ||
        ...
        sendEvent(controller, {
          ...
          description:
            "Converting research findings into structured syllabus format",
        });

        sendEvent(controller, {
          type: "structuring",
          message:
            "Generating modules, learning objectives, and assessment questions...",
        });
